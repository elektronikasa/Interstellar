  ...
  cartItems: [
    {
      ...
      hierarchicalCategories: {
        lvl0: 'Cameras & Camcorders', lvl1: 'Cameras & Camcorders > Digital Cameras', lvl2: 'Cameras & Camcorders > Digital Cameras > Digital SLR Cameras', lvl3: 'Cameras & Camcorders > Digital Cameras > Digital SLR Cameras > DSLR Body & Lens'
      },
      type: 'Dslr cameras',
      price: 4099.99,
      price_range: '> 2000',
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'TV & Home Theater', lvl1: 'TV & Home Theater > TVs', lvl2: 'TV & Home Theater > TVs > 4K Ultra HD TVs' },
      ...
      objectID: '4803900',
      _highlightResult: {
        name: { value: 'Sony - 75&quot; Class (74.5&quot; diag) - LED - 2160p - Smart - 3D - 4K Ultra HD TV with High Dynamic Range - Black', matchLevel: 'none', matchedWords: [] }, description: { value: 'This Sony 4K HDR TV boasts 4K technology for vibrant hues. Its X940D series features a bold 75-inch screen and slim design. Wires remain hidden, and the unit is easily wall mounted. This television has a 4K Processor X1 and 4K X-Reality PRO for crisp video. This Sony 4K HDR TV is easy to control via voice commands.', matchLevel: 'none', matchedWords: [] }, brand: { value: 'Sony', matchLevel: 'none', matchedWords: [] }, categories: [{ value: 'TV &amp; Home Theater', matchLevel: 'none', matchedWords: [] }, { value: 'TVs', matchLevel: 'none', matchedWords: [] }, { value: '4K Ultra HD TVs', matchLevel: 'none', matchedWords: [] }]
      },
      quantity: 1,
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Audio', lvl1: 'Audio > Headphones', lvl2: 'Audio > Headphones > All Headphones' },
      ...
      _highlightResult: {
        name: {
          value: '<mark>Beats</mark> <mark>by</mark> <mark>Dr.</mark> Dre - Geek Squad Certified Refurbished <mark>Beats</mark> Studio Wireless On-Ear Headphones - Red', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['beats', 'by', 'dr']
        },
        description: {
        ...
        brand: {
          value: '<mark>Beats</mark> <mark>by</mark> <mark>Dr.</mark> Dre', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['beats', 'by', 'dr']
        },
        categories: [{ value: 'Audio', matchLevel: 'none', matchedWords: [] }, { value: 'Headphones', matchLevel: 'none', matchedWords: [] }, { value: 'All Headphones', matchLevel: 'none', matchedWords: [] }]
      },
      quantity: 1,
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Video Games', lvl1: 'Video Games > PlayStation 4', lvl2: 'Video Games > PlayStation 4 > PS4 Consoles' },
      ...
      _highlightResult: {
        name: {
          value: '<mark>Sony</mark> - <mark>Pla</mark>yStation 4 Pro Console', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['sony', 'pla']
        },
        description: { value: 'PS4 Pro Dynamic 4K Gaming &amp; 4K Entertainment* PS4 Pro gets you closer to your game. Heighten your experiences. Enrich your adventures. Let the super-charged PS4 Pro lead the way.** GREATNESS AWAITS', matchLevel: 'none', matchedWords: [] },
        brand: {
          value: '<mark>Sony</mark>', matchLevel: 'partial', fullyHighlighted: true, matchedWords: ['sony']
        },
        categories: [{ value: 'Video Games', matchLevel: 'none', matchedWords: [] }, {
          value: '<mark>Pla</mark>yStation 4', matchLevel: 'partial', fullyHighlighted: false, matchedWords: ['pla']
    ...
    },
    {
      ...
      hierarchicalCategories: {
        lvl0: 'Computers & Tablets', lvl1: 'Computers & Tablets > Laptops', lvl2: 'Computers & Tablets > Laptops > All Laptops', lvl3: 'Computers & Tablets > Laptops > All Laptops > MacBooks'
      },
      type: 'Apple',
      price: 1599.99,
      ...
      _highlightResult: {
        name: {
          value: '<mark>Apple</mark> - Macbook® (Latest Model) - 12&quot; Display - Intel Core M5 - 8GB Memory - 512GB Flash Storage - Space Gray', matchLevel: 'partial', fullyHighlighted: false, matchedWords: ['apple']
        },
        description: { value: 'MacBook delivers a full-size experience in the lightest and most compact Mac notebook ever. With a full-size keyboard, force-sensing trackpad, 12-inch Retina display,1 sixth-generation Intel Core M processor, multifunctional USB-C port, and now up to 10 hours of battery life,2 MacBook features big thinking in an impossibly compact form.', matchLevel: 'none', matchedWords: [] },
        brand: {
          value: '<mark>Apple</mark>', matchLevel: 'partial', fullyHighlighted: true, matchedWords: ['apple']
        },
        categories: [{ value: 'Computers &amp; Tablets', matchLevel: 'none', matchedWords: [] }, {
          value: '<mark>Laptops</mark>', matchLevel: 'partial', fullyHighlighted: true, matchedWords: ['laptop']
        }, {
          value: 'All <mark>Laptops</mark>', matchLevel: 'partial', fullyHighlighted: false, matchedWords: ['laptop']
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Wearable Technology', lvl1: 'Wearable Technology > Apple Watch', lvl2: 'Wearable Technology > Apple Watch > Apple Watch Series 1' },
      ...
      _highlightResult: {
        name: {
          value: '<mark>Apple</mark> - <mark>Apple</mark> Watch Series 1 42mm Space Gray Aluminum Case Black Sport Band - Space Gray Aluminum', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['apple']
        },
        description: {
          value: 'Durable, lightweight aluminum cases in silver, space gray, gold, and rose gold. Sport Band in a variety of colors. All the features of the original <mark>Apple</mark> Watch, plus a new dual-core processor for faster performance. All models run watchOS 3. Requires an iPhone 5 or later.', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['apple']
        },
        brand: {
          value: '<mark>Apple</mark>', matchLevel: 'full', fullyHighlighted: true, matchedWords: ['apple']
        },
        categories: [{ value: 'Wearable Technology', matchLevel: 'none', matchedWords: [] }, {
          value: '<mark>Apple</mark> Watch', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['apple']
        }, {
          value: '<mark>Apple</mark> Watch Series 1', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['apple']
        }],
        type: {
          value: 'Standard <mark>apple</mark> watch', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['apple']
        }
      },
      quantity: 1,
  ...
  wishList: [
    {
      ...
      hierarchicalCategories: {
        lvl0: 'Audio', lvl1: 'Audio > Home Audio', lvl2: 'Audio > Home Audio > Speakers', lvl3: 'Audio > Home Audio > Speakers > Floor Speakers'
      },
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Appliances', lvl1: 'Appliances > Refrigerators', lvl2: 'Appliances > Refrigerators > All Refrigerators' },
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Computers & Tablets', lvl1: 'Computers & Tablets > All Desktops' },
      type: "Apple cpu's",
      price: 3199.99,
      price_range: '> 2000',
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Computers & Tablets', lvl1: 'Computers & Tablets > Laptops' },
      type: 'Gaming laptops',
      price: 1999.99,
      price_range: '500 - 2000',
      ...
      _highlightResult: {
        name: {
          value: '<mark>Alien</mark>ware - 17.3&quot; Laptop - Intel Core i7 - 16GB Memory - NVIDIA GeForce GTX 1070 - 1TB Hard Drive + 128GB Solid State Drive - Silver', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['alien']
        },
        description: {
          value: '<mark>Alien</mark>ware Laptop: Bring video games to life with this 17.3-inch Dell <mark>Alien</mark>ware laptop. It has a powerful quad-core Intel Core i7 processor and 16GB of DDR4 RAM to run modern games quickly, and its 1TB hard drive stores plenty of game and other files. This Dell <mark>Alien</mark>ware laptop has a 2.1 speaker configuration with a subwoofer for a dynamic gaming experience.', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['alien']
        },
        brand: {
          value: '<mark>Alien</mark>ware', matchLevel: 'full', fullyHighlighted: false, matchedWords: ['alien']
        },
        categories: [{ value: 'Computers &amp; Tablets', matchLevel: 'none', matchedWords: [] }, { value: 'Laptops', matchLevel: 'none', matchedWords: [] }]
      }
    },
    {
    ...
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Video Games', lvl1: 'Video Games > PC Gaming', lvl2: 'Video Games > PC Gaming > Virtual Reality for PC' },
      type: '',
      price: 4999.99,
      price_range: '> 2000',
      ...
      objectID: '5582501',
      _highlightResult: {
        name: { value: 'Asus - ROG Desktop - Intel Core i7 - 16GB Memory - Double NVIDIA GeForce GTX1080 - 1TB Hard Drive + 2x512GB Solid State Drive - Gray', matchLevel: 'none', matchedWords: [] }, description: { value: 'Place the sleek form of this ASUS desktop computer tower on your desk, and take your gaming to the next level. With Intel Core i7 processing inside, this speedy desktop keeps up with even multilayered action games. Nvidia graphics on this ASUS desktop computer help eliminate ghosting and stutter so you see every move your enemy makes.', matchLevel: 'none', matchedWords: [] }, brand: { value: 'Asus', matchLevel: 'none', matchedWords: [] }, categories: [{ value: 'Video Games', matchLevel: 'none', matchedWords: [] }, { value: 'PC Gaming', matchLevel: 'none', matchedWords: [] }, { value: 'Virtual Reality for PC', matchLevel: 'none', matchedWords: [] }]
      }
    },
    {
      ...
      hierarchicalCategories: { lvl0: 'Audio', lvl1: 'Audio > Headphones', lvl2: 'Audio > Headphones > On-Ear Headphones' },
