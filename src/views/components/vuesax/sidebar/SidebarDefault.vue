...
<template>
  ...
  >
    ...
    >
      <p>
        To add an internal link using <a
          href="https://router.vuejs.org/"
          targte="_blank"
        >vue-router</a> you can do them simply by adding the property <a href="https://router.vuejs.org/api/#to">to</a> as if it were a vue-router link.
        <br>
