...
<template>
  <div id="extra-component-datepicker-demo">
    <p class="mb-4">
      A simple Vue.js datepicker component. Supports disabling of dates, inline mode, translations. Read full documnetation <a
    ...
    <div class="vx-row match-height">
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-default class="mb-base" />
      </div>
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-format class="mb-base" />
      </div>
    </div>

    <div class="vx-row match-height">
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-min-max-date-range class="mb-base" />
      </div>
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-highlight-dates class="mb-base" />
      </div>
    </div>

    <div class="vx-row match-height">
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-inline class="mb-base" />
      </div>
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-open-programatically class="mb-base" />
      </div>
    </div>

    <div class="vx-row match-height">
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-translation class="mb-base" />
      </div>
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-rtl class="mb-base" />
      </div>
    </div>

    <div class="vx-row match-height">
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-day-view-only class="mb-base" />
      </div>
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-month-view-only class="mb-base" />
      </div>
    </div>

    <div class="vx-row match-height">
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-date-month-view-only />
      </div>
      <div class="vx-col md:w-1/2 w-full">
        <datepicker-month-year-view-only />
      </div>
    </div>
  </div>
</template>
