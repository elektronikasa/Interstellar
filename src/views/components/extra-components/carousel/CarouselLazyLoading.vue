...
<template>
  ...
  >
    ...
    <swiper :options="swiperOption">
      <swiper-slide>
        <img
          :data-src="require('../../../../assets/images/slider/01.jpg')"
          class="swiper-lazy"
        >
      ...
      <swiper-slide>
        <img
          :data-src="require('../../../../assets/images/slider/02.jpg')"
          class="swiper-lazy"
        >
        <div class="swiper-lazy-preloader swiper-lazy-preloader-white" />
      </swiper-slide>
      <swiper-slide>
        <img
          :data-src="require('../../../../assets/images/slider/03.jpg')"
          class="swiper-lazy"
        >
        <div class="swiper-lazy-preloader swiper-lazy-preloader-white" />
      </swiper-slide>
      <swiper-slide>
        <img
          :data-src="require('../../../../assets/images/slider/04.jpg')"
          class="swiper-lazy"
        >
        <div class="swiper-lazy-preloader swiper-lazy-preloader-white" />
      </swiper-slide>
      <swiper-slide>
        <img
          :data-src="require('../../../../assets/images/slider/05.jpg')"
          class="swiper-lazy"
        >
        <div class="swiper-lazy-preloader swiper-lazy-preloader-white" />
      </swiper-slide>
