  ...
  <div id="extra-component-drag-and-drop-demo">
    <p class="mb-4">
      <a
        ...
        target="_blank"
        rel="nofollow"
      >Vue.Draggable</a> - Vue component allowing drag-and-drop and synchronization with view model array. Based on and offering all features of Sortable.js
    </p>

    <drag-and-drop-simple />
    <drag-and-drop-multiple-lists />
    <drag-and-drop-clone-list />
