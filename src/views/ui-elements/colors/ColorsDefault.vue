...
<template>
  ...
  >
    ...
    <vx-list :list="defaultColors" />

    <p class="mb-5">
      For each color, we think has its functionality in the application as alerts of errors (<strong>danger</strong>), warnings to the user (<strong>warning</strong>), communications of approval (<strong>success</strong>), or main color of the application (<strong>primary</strong>).
    </p>
