...
<template>
  ...
  >
    ...
    <p class="mt-5">
      By doing this, all <strong>Vuesax</strong> components in the application that use a primary color with change. Select one of the colors to change it and that all the components of this documentation have that color.
    </p>
