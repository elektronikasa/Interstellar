  ...
  >
    ...
    <div class="mt-5">
      ...
      <div class="flex flex-wrap">
        <div
          :class="colClass"
          class="mb-4 h-12 bg-grid-color"
        />
        <div
          :class="colClass"
          class="mb-4 h-12 bg-grid-color-secondary"
        />
        <div
          :class="colClass"
          class="mb-4 h-12 bg-grid-color"
