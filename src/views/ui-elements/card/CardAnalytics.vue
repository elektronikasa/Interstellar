    ...
    <div class="vx-row">
          ...
          <ul>
            ...
            >
              <feather-icon
                ...
                :svg-classes="[`h-5 w-5 stroke-current text-${deviceData.color}`]"
              />
              ...
              <div class="ml-auto flex -mr-1">
                ...
                <feather-icon
                  ...
                  :svg-classes="[deviceData.comparedResultPercentage < 0 ? 'text-danger' : 'text-success' ,'stroke-current h-4 w-4 mb-1 mr-1']"
                />
              </div>
            </li>
          </ul>
      ...
      <div class="vx-col w-full lg:w-1/3 mb-base">
        <vx-card title="Product Orders">
          ...
          <ul>
            <li
              v-for="orderData in analyticsData.productOrdersRadialBar.analyticsData"
    ...
    <div class="vx-row">
      ...
      <div class="vx-col w-full md:w-1/2 lg:w-1/2 xl:w-1/2 mb-base">
        ...
        >
          ...
          <!-- LABELS -->
          <div class="flex">
            <span class="flex items-center"><div class="h-3 w-3 rounded-full mr-2 bg-primary" /><span>Sales</span></span>
            <span class="flex items-center ml-5"><div class="h-3 w-3 rounded-full mr-2 bg-success" /><span>Visits</span></span>
          </div>
          <!-- CHART -->
        ...
        <vx-card title="Support Tracker">
          ...
          <div slot="no-body">
            ...
            <div class="flex flex-row justify-between px-8 pb-4">
              <p class="text-center">
                <span class="block">New Tickets</span><span class="text-4xl">29</span>
              </p>
              <p class="text-center">
                <span class="block">Open Tickets</span><span class="text-4xl">63</span>
              </p>
              <p class="text-center">
                <span class="block">Response Time</span><span class="text-4xl">1d</span>
              </p>
            </div>
          </div>
        </vx-card>
        ...
        <vx-card title="Sales">
          ...
          >
            <vue-apex-charts
              ...
              :series="analyticsData.salesLine.series"
            />
          </div>
        </vx-card>
      </div>
        ...
        <vx-card>
          <template slot="no-body">
            <div class="p-8 clearfix">
              ...
              <p class="mt-2 mb-8 text-xl text-success font-medium">
                +5.2% ($956)
              </p>
              <vs-button
                icon-pack="feather"
    ...
    <div class="vx-row mt-base">
              ...
              <div class="flex flex-col text-right">
                <span class="flex -mr-1">
                  ...
                  <feather-icon
                    ...
                    :svg-classes="[browser.comparedResult < 0 ? 'text-danger' : 'text-success' ,'stroke-current h-4 w-4 mb-1 mr-1']"
                  />
                </span>
      ...
      <div class="vx-col w-full md:w-2/3">
        <vx-card title="Client Retention">
          <div class="flex">
            <span class="flex items-center"><div class="h-3 w-3 rounded-full mr-1 bg-warning" /><span>New Clients</span></span>
