    ...
    <div class="vx-row">
      <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
        <vx-card>
          <div slot="no-body">
            <img
              :src="require(`@/assets/images/pages/${card_1.contentImg1}`)"
              alt="content-img"
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
        <vx-card>
          <img
            :src="require(`@/assets/images/pages/${card_2.contentImg2}`)"
            alt="content-img"
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
        <vx-card>
          <img
            :src="require(`@/assets/images/pages/${card_3.contentImg3}`)"
            alt="content-img"
            class="responsive rounded-lg"
          >
          <div class="my-6">
      ...
      <div class="vx-col w-full sm:w-1/2 md:w-1/3 mb-base">
        <vx-card class="p-2">
          <vs-avatar
            ...
            size="80px"
            :src="require(`@/assets/images/portrait/small/${card_4.userImg}`)"
          />
      ...
      <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base">
        <vx-card class="p-2">
          ...
          <vs-avatar
            ...
            size="80px"
            :src="require(`@/assets/images/portrait/small/${ card_5.userImg }`)"
          />
      ...
      <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base">
        <vx-card class="overlay-card overflow-hidden">
          <template slot="no-body">
            <img
              :src="require(`@/assets/images/pages/${card_7.overlay_img}`)"
      ...
      <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base">
        <vx-card class="overlay-card overflow-hidden">
          <template slot="no-body">
            <img
              :src="require('@/assets/images/pages/card-image-5.jpg')"
              alt="user-profile-cover"
      ...
      <div class="vx-col w-full md:w-1/3 sm:w-1/2 mb-base">
        ...
        >
          ...
          <img
            :src="require(`@/assets/images/pages/${card_9.img}`)"
            alt="content-img"
            class="responsive rounded-lg"
          >
          <div class="flex mt-6 flex-wrap">
            <span class="flex mr-6"><feather-icon
              class="cursor-pointer"
              icon="ThumbsUpIcon"
              svg-classes="text-success stroke-current h-6 w-6"
            /><span class="ml-2">368</span></span>
            <span class="flex mr-6"><feather-icon
              class="cursor-pointer"
              icon="MessageSquareIcon"
              svg-classes="text-primary stroke-current h-6 w-6"
            /><span class="ml-2">341</span></span>
            <span class="flex mr-6"><feather-icon
              class="cursor-pointer"
              icon="ThumbsDownIcon"
              svg-classes="text-danger stroke-current h-6 w-6"
            /><span class="ml-2">53</span></span>
          </div>
        </vx-card>
      </div>
