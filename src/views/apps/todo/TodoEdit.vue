        ...
        <div class="vx-row">
          ...
          <div class="vx-col ml-auto flex">
            <feather-icon
              ...
              :svg-classes="[{'text-success stroke-current': isImportantLocal}, 'w-5', 'h-5 mr-4']"
              @click.prevent="toggleIsImportant"
            />

            <feather-icon
              icon="StarIcon"
              class="cursor-pointer"
              :svg-classes="[{'text-warning stroke-current': isStarredLocal}, 'w-5', 'h-5 mr-4']"
              @click.prevent="toggleIsStarred"
            />
