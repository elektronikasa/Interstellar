...
<template>
  ...
  >
    ...
    <div class="flex w-full">
      <vs-avatar
        class="sender__avatar flex-no-shrink mr-3 border-2 border-solid border-white"
        :src="require(`@/assets/images/portrait/small/${mail.img}`)"
        size="40px"
      />
    ...
    <div class="flex w-full">
      <div class="flex items-center ml-1">
        ...
        <feather-icon
          ...
          :svg-classes="[{'text-warning fill-current stroke-current': mail.isStarred}, 'w-5', 'h-5']"
