  ...
  <div id="extra-component-form-validation-demo">
    <p class="mb-4">
      <a
        ...
        target="_blank"
        rel="nofollow"
      >vee-validate</a> is a Template Based Validation Framework for Vue.js. Read full documentation <a
    ...
    <form-validation-multiple-rules />
    <div class="vx-row">
      <div class="vx-col w-1/2">
        <form-validation-custom-error-messages class="mb-base" />
      </div>
      <div class="vx-col w-1/2">
        <form-validation-events class="mb-base" />
      </div>
    </div>
