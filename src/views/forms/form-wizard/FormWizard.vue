  ...
  <div id="extra-component-form-wizard-demo">
    <p class="mb-4">
      <a
        ...
        target="_blank"
        rel="nofollow"
      >vue-form-wizard</a> is a vue based component with no external depenendcies which simplifies tab wizard management and allows you to focus on the functional part of your app rather than wasting time on details.
    </p>

    <form-wizard-number-tab />
    <form-wizard-icon-tab />
