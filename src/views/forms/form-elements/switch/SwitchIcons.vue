...
<template>
  ...
  >
    ...
    <vs-alert
      ...
      class="mt-5"
    >
      <span>Vuesax uses the <strong>Google Material Icons</strong> font library. For a list of all available icons, visit the official <a
        href="https://material.io/icons/"
        target="_blank"
      >Material Icons page.</a></span>
    </vs-alert>
