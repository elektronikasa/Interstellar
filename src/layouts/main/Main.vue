...
<template>
    <div class="layout--main" :class="[navbarClasses, footerClasses, {'app-page': isAppPage}]">
        ...
        <the-customizer
            ...
            />
        <vx-sidebar :sidebarItems="sidebarItems" :logo="require('@/assets/images/logo/digi-outsource-logo.png')" title="" parent=".layout--main" />
...
export default {
  ...
  computed: {
    ...
    contentAreaClass () {
      ...
      if (this.sidebarWidth) return 'content-area-full'
    },
    navbarClasses () {
      return {
